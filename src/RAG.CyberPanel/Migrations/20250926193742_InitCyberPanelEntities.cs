...
{
    /// <inheritdoc />
    public partial class InitCyberPanelEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizAnswerOptions", x => new { x.QuizAnswerId, x.OptionId });
                    table.ForeignKey(
                        name: "FK_QuizAnswerOptions_Options_OptionId",
                        column: x => x.OptionId,
                        principalTable: "Options",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizAnswerOptions_QuizAnswers_QuizAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAnswerOptions_OptionId",
