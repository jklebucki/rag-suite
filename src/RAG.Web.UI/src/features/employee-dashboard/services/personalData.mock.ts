...
const MOCK_DATA: PersonalDataPageData = {
  personalData: {
    ...
    employments: [
      ...
      {
        id: 'emp-polskie-pomidory',
        company: 'Polskie Pomidory Sp. z o.o.',
        organizationalUnit: 'Dział Technologii',
        costCenter: 'CC-TECH-007',
        contractType: 'Umowa o pracę na czas określony',
        workTimeFraction: '1/4 etatu',
        employmentStatus: 'Aktywny',
        hireDate: '2022-07-01',
      },
    ],
