...
export interface TranslationKeys {
  ...
  'addressBook.form.emailPlaceholder': string;
  'addressBook.form.mobilePhonePlaceholder': string;
  'addressBook.form.workPhonePlaceholder': string;
  'addressBook.form.companyPlaceholder': string;
  'addressBook.form.departmentPlaceholder': string;
  'addressBook.form.positionPlaceholder': string;
  'addressBook.form.locationPlaceholder': string;
  'addressBook.form.notesPlaceholder': string;
  'addressBook.form.photoUrlPlaceholder': string;
  'addressBook.form.tagInputPlaceholder': string;
  'addressBook.form.addTag': string;
  'addressBook.form.proposalNotice': string;
