...
export interface TranslationKeys {
  ...
  'about.hero.headline': string;
  'about.hero.description': string;
  'about.hero.fact.rag': string;
  'about.hero.fact.sources': string;
  'about.hero.fact.languages': string;
  'about.capabilities.eyebrow': string;
  'about.capabilities.title': string;
  'about.capabilities.description': string;
  'about.capabilities.ask.title': string;
  'about.capabilities.ask.description': string;
  'about.capabilities.ask.point1': string;
  'about.capabilities.ask.point2': string;
  'about.capabilities.find.title': string;
  'about.capabilities.find.description': string;
  'about.capabilities.find.point1': string;
  'about.capabilities.find.point2': string;
  'about.capabilities.grow.title': string;
  'about.capabilities.grow.description': string;
  'about.capabilities.grow.point1': string;
  'about.capabilities.grow.point2': string;
  'about.flow.ariaLabel': string;
  'about.flow.question': string;
  'about.flow.information': string;
  'about.flow.knowledge': string;
  'about.flow.processes': string;
  'about.roadmap.eyebrow': string;
  'about.roadmap.title': string;
  'about.roadmap.description': string;
  'about.roadmap.available.title': string;
  'about.roadmap.available.description': string;
  'about.roadmap.available.item1': string;
  'about.roadmap.available.item2': string;
  'about.roadmap.available.item3': string;
  'about.roadmap.now.title': string;
  'about.roadmap.now.description': string;
  'about.roadmap.now.item1': string;
  'about.roadmap.now.item2': string;
  'about.roadmap.now.item3': string;
  'about.roadmap.direction.title': string;
  'about.roadmap.direction.description': string;
  'about.roadmap.direction.item1': string;
  'about.roadmap.direction.item2': string;
  'about.roadmap.direction.item3': string;
  'about.value.eyebrow': string;
  'about.value.title': string;
  'about.value.description': string;
  'about.value.primary.title': string;
  'about.value.primary.description': string;
  'about.value.questions.title': string;
  'about.value.questions.description': string;
  'about.value.sources.title': string;
  'about.value.sources.description': string;
  'about.value.onboarding.title': string;
  'about.value.onboarding.description': string;
  'about.value.retention.title': string;
  'about.value.retention.description': string;
  'about.value.quality.title': string;
  'about.value.quality.description': string;
  'about.authors.title': string;
  'about.authors.description': string;
  'about.authors.person1.name': string;
  'about.authors.person1.role': string;
  'about.authors.person2.name': string;
  'about.authors.person2.role': string;
  'about.authors.person3.name': string;
  'about.authors.person3.role': string;
