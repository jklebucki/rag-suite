...
namespace RAG.Orchestrator.Api.Migrations
{
    ...
    [Migration("20260725083046_AddChatDocuments")]
    partial class AddChatDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RAG.Orchestrator.Api.Features.Chat.Artifacts.GeneratedArtifactEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_generated_artifacts");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_generated_artifacts_expires_at");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("ix_generated_artifacts_session_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_generated_artifacts_user_id");

                    b.ToTable("generated_artifacts", (string)null);
                });

            modelBuilder.Entity("RAG.Orchestrator.Api.Models.ChatDocument", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
            ...
            modelBuilder.Entity("RAG.Orchestrator.Api.Models.FeedbackAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_feedback_attachments");
            ...
            modelBuilder.Entity("RAG.Orchestrator.Api.Models.ChatDocument", b =>
                {
                    b.HasOne("RAG.Orchestrator.Api.Models.ChatMessage", "UserMessage")
                        .WithMany()
                        .HasForeignKey("UserMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_chat_documents__chat_messages_user_message_id");
            ...
            modelBuilder.Entity("RAG.Orchestrator.Api.Models.FeedbackAttachment", b =>
                {
                    b.HasOne("RAG.Orchestrator.Api.Models.Feedback", "Feedback")
                        .WithMany("Attachments")
                        .HasForeignKey("FeedbackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_feedback_attachments_feedback_entries_feedback_id");
